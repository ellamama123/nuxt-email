  ...
  <CRow>
    <CCol col="12" md="6">
      <CCard>
        ...
        <CCardBody>
          <h2>
            Example heading <CBadge color="primary">
              New
            </CBadge>
          </h2>
          <h3>
        ...
        <CCardFooter>
          <CButton color="primary">
            Notifications
            <CBadge color="light" class="ml-2 position-static">
              4
            </CBadge>
          </CButton>
        </CCardFooter>
    ...
    <CCol col="12" md="6">
      ...
      <CCard>
        ...
        <CCardBody>
          <CBadge href="#" color="primary">
            Primary
          </CBadge>
          <CBadge href="#" color="secondary">
            Secondary
          </CBadge>
          <CBadge href="#" color="success">
            Success
          </CBadge>
          <CBadge href="#" color="danger">
            Danger
          </CBadge>
          <CBadge href="#" color="warning">
            Warning
          </CBadge>
          <CBadge href="#" color="info">
            Info
          </CBadge>
          <CBadge href="#" color="light">
            Light
          </CBadge>
          <CBadge href="#" color="dark">
            Dark
          </CBadge>
        </CCardBody>
      </CCard>
